...
chanceCards = [
    ...
    { "text": "Vous êtes impose pour les reparations de voirie a raison de : 40€ par appartement et 115€ par hôtel.", 'cast': lambda x: x.transaction(-(x.countConstruction()[0]*40 + x.countConstruction()[1]*115)), 'historyText': "Vous perdez de l'argent €" },
    { "text": "Faites des reparations dans toutes vos maisons. Versez pour chaque maison 25€. Versez pour chaque hôtel 100€.", 'cast': lambda x: x.transaction(-(x.countConstruction()[0]*25 + x.countConstruction()[1]*100)), 'historyText': "Vous perdez de l'argent €" },
